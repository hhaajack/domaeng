...
// Purpose: Reads the installed Domaeng package version and caches the latest published npm version.
// Layer: CLI helper
...
const DOMAENG_REGISTRY_URL = "https://registry.npmjs.org/domaeng/latest";
...
function createBridgePackageVersionStatusReader({
  ...
  registryUrl = DOMAENG_REGISTRY_URL,
