...
private extension CodexBridgeUpdatePrompt {
    static let previewScannerMismatch = CodexBridgeUpdatePrompt(
        ...
        message: "This QR code was generated by a Remodex bridge version this app was not adapted for. Install the adapted bridge version before scanning a new QR code.",
